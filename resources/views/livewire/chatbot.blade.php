            ...
            @if(empty($messages))
                ...
                <div class="bg-white px-6 pt-6 pb-4">
                    <flux:text size="lg" class="flex items-start gap-2">
                        ...
                        <span>Bienvenue dans le configurateur intelligent de création de fichier CAO simple (STEP) sur-mesure et instantanément. Vous pouvez démarrer votre demande de fichier CAO de 3 manières :</span>
                    </flux:text>
                </div>
            @endif
