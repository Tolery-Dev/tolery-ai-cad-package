                ...
                @if($amount)
                    ...
                    <div class="bg-violet-50 border border-violet-200 rounded-lg p-4 space-y-2">
                        <div class="flex justify-between items-center text-sm text-zinc-600">
                            ...
                            <span>{{ number_format($ht, 2, ',', ' ') }} €</span>
                        </div>
                        <div class="flex justify-between items-center text-sm text-zinc-600">
                            <span>TVA (20 %)</span>
                            <span>{{ number_format($tva, 2, ',', ' ') }} €</span>
                        </div>
                        <div class="border-t border-violet-200 pt-2 flex justify-between items-center">
                            <span class="font-medium text-zinc-700">Total TTC</span>
                            <span class="text-2xl font-bold text-violet-600">{{ number_format($ttc, 2, ',', ' ') }} €</span>
                        </div>
                    </div>
                @endif
                        ...
                        <div class="flex gap-3 justify-end pt-4 border-t border-zinc-200">
                            ...
                            <div class="relative" x-data="{ showTooltip: false }">
                                ...
                                <div
                                    x-show="showTooltip"
                                    x-transition
                                    class="absolute bottom-full left-1/2 -translate-x-1/2 mb-2 px-3 py-1.5 text-xs text-white bg-zinc-800 rounded-lg whitespace-nowrap shadow-lg z-20">
                                    Vous devez accepter les CGV ci-dessus
                                ...
                                <flux:button
                                    ...
                                    <span x-show="!processing">Payer</span>
