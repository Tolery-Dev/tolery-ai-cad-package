<header class="flex items-center gap-2.5 px-6 pt-8 pb-6 border-b border-grey-stroke dark:border-zinc-800 bg-white dark:bg-zinc-950 shrink-0">
    ...
    <div
        ...
        <span
            x-show="!editing"
            @click="editing = true"
            class="inline-flex items-center gap-2 text-sm font-semibold text-black dark:text-white cursor-pointer hover:text-violet-600 dark:hover:text-violet-400 transition-colors">
            <span x-text="name" class="text-xl"></span>
            <svg class="w-4 h-4 text-gray-500 dark:text-zinc-400" viewBox="0 0 20 20" fill="none" aria-hidden="true">
