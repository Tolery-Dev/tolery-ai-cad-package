<header class="flex items-center gap-2.5 px-6 pt-8 pb-6 border-b border-grey-stroke bg-white rounded-tl-4xl shrink-0">
    <button
        ...
        class="w-8 h-8 border border-[#CECECE] rounded flex items-center justify-center hover:bg-gray-50 dark:hover:bg-zinc-800 transition-colors shrink-0">
    ...
    <div
        ...
        <span
            x-show="!editing"
            @click="editing = true"
            class="inline-flex items-center gap-2 text-sm font-semibold text-black cursor-pointer hover:text-violet-600 dark:hover:text-violet-400 transition-colors">
